...
|08|Combining Operators|다수의 소스 Observable을 작업하여 하나의 Observable을 생성하는 연산자|
|09|Conditional Operators|하나 이상의 Observable 또는 Observable이 배출한 항목을 평가하는 연산자|
|10|Time-based Operators|시간 기반의 연산자|
